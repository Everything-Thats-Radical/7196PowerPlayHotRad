...
@Disabled
@TeleOp (name = "HotRadTeleEnhancedPickup", group = "Iterative Opmode")
public class HotRadTeleEnhancedPickup extends LinearOpMode {
    @Override
...
initialization{
	...
	boolean moveToDesired;
}
gameLoop{
	if (gamepad1.a){
		desiredPosition = liftInchesToTicks(6);
		moveToDesired = true;
	}
	if (moveToDesired){
	    currentPosition = up.getCurrentPosition();
