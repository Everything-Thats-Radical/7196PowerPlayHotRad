...
public class GoatedWithTheSauce extends LinearOpMode {
    public static double MOTOR_RAMP_CONSTANT = 8;
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) { //Code to run REPEATEDLY after the driver hits PLAY but before they hit STOP
            ...
            frontLeftPower = (frontLeftPower - FLDrive.getPower())/MOTOR_RAMP_CONSTANT; // motor ramp function
            backLeftPower = (backLeftPower - BLDrive.getPower())/MOTOR_RAMP_CONSTANT;
            frontRightPower = (frontRightPower - FRDrive.getPower())/MOTOR_RAMP_CONSTANT;
            backRightPower = (backRightPower - BRDrive.getPower())/MOTOR_RAMP_CONSTANT;
